...
public class ComptabiliteManagerImplTestU extends BusinessTestCase {
	...
	public void create_ecritureComptable() throws NotFoundException {
		...
		// GIVEN
		EcritureComptable ecritureComptable = aEcritureComptable().journal(new JournalComptable("AC", "Achat"))
				.ref("AC-2019/00450").libelle("Achat").date(new Date()).build();
		...
		ecritureComptable.getListLigneEcriture()
				.add(new LigneEcritureComptable(new CompteComptable(401), null, null, new BigDecimal(123)));
