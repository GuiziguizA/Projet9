...
public class SequenceEcritureComptableBuilder {
	...
	public void mapRow() {
		...
		SequenceEcritureComptable sequenceEcritureComptable = template
				.queryForObject("SELECT * FROM sequence_ecriture_comptable WHERE journal_code = 401", rm);
